...
// Notes par matière
$notesParMatiere = $pdo->query("SELECT m.nom_matiere, COUNT(ev.id_evaluation) as total
    FROM matieres m
    LEFT JOIN evaluations ev ON m.id_matiere = ev.id_matiere
    GROUP BY m.nom_matiere")->fetchAll(PDO::FETCH_ASSOC);
?>
...
<head>
    ...
    <style>
        ...
        h2 {
            color: #00796b; /* Sous-titre en bleu-vert */
        }
        table {
            width: 100%;
